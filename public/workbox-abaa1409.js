define('./workbox-abaa1409.js', ['exports'], function(exports) {
  'use strict'
  ...
  async function copyResponse(response, modifier) {
    ...
    const modifiedResponseInit = modifier
      ...
      : responseInit // Create the new response from the body stream and `ResponseInit`
    ...
    self.addEventListener('fetch', event => {
...

      {
        responsePromise = responsePromise.then(response => {
          ...
          logger.groupCollapsed(
            `Precaching is responding to: ` + getFriendlyURL(event.request.url)
          )
...
//# sourceMappingURL=workbox-abaa1409.js.map
